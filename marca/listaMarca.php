...
<?php include("../menuSuperior.php"); ?>
    ...
    <div class="container-fluid">
           		...
           		<div class="panel panel-default">
                    ...
                    <form action="<?php $_SERVER["PHP_SELF"] ?>" method="get">
                        <div class="form-group">
                            ...
                            <input placeholder="Busca Por Marca" name="nome" type="text">
      ...
      <div class="panel-heading">Marca <a href="cadastrarMarca.php"><button class="btn btn-info" type="button">Cadastrar Marca</button></a></div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                     <?php 
						...
						$b = "select idMarca, descricao from marca $buscaG order by descricao LIMIT $inicial, $numreg;";
						
						
						$busca = mysql_query($b);
						
						$b = "select idMarca, descricao from marca $buscaG;";
                     ...
                     <tr>
                        ...
                        <td>
                        <a  title="Editar Registro" href="alterarMarca.php?idMarca=<?php echo($result[0]); ?>" class="btn btn-info glyphicon glyphicon-pencil"> Alterar</a>
                        </td>
                        <td> <a  title="Ecluir Registro" href="excluirMarca.php?idMarca=<?php echo($result[0]); ?>" class="btn btn-danger simpleConfirm glyphicon glyphicon-trash"> Excluir</a> </td>                       
                     <?php }}else{ ?>
                     
                     <td colspan="3"><label for="Nao">Não há Marca</label>  </td> 
