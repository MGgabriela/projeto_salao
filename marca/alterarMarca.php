...
extract($_GET);
$resul = mysql_fetch_array(mysql_query("select descricao from marca where idMarca=$idMarca;"));
?>
<!DOCTYPE html>
<html><head>    
        <title>Senac</title>
      ...
      <script type="text/javascript">
			$().ready(function(){
				$('#formularioCargo').validate({
					...
					messages:{
						descricaoAlterar:{ required: 'Este Campo é obrigatorio' , remote: 'Esta Marca já existe.'}
					}
            ...
            <div class="col-md-9">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
    					<h3 class="panel-title">Alterar Marca</h3>
    				</div>
    				<div class="panel-body">
    					<form id="formularioCargo" method="post" action="alterarMarcaSalvar.php">
                              ...
                              <input type="hidden" name="descricaoAntigo" value="<?php echo($idMarca); ?>">
						</form>
    				</div>
				</div>
