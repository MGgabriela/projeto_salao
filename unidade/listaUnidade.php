...
<?php include("../menuSuperior.php"); ?>
    ...
    <div class="container-fluid">
           		...
           		<div class="panel panel-default">
                    ...
                    <form action="<?php $_SERVER["PHP_SELF"] ?>" method="get">
                        <div class="form-group">
                            ...
                            <input placeholder="Busca Por Unidade" name="nome" type="text">
      ...
      <div class="panel-heading">Unidade <a href="cadastrarUnidade.php"><button class="btn btn-info" type="button">Cadastrar Unidade</button></a></div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                     <?php 
						...
						$b = "select idunidade, descricao from unidade $buscaG order by descricao LIMIT $inicial, $numreg;";
						
						
						$busca = mysql_query($b);
						
						$b = "select idunidade, descricao from unidade $buscaG;";
                     ...
                     <tr>
                        ...
                        <td>
                        <a  title="Editar Registro" href="alterarUnidade.php?idUnidade=<?php echo($result[0]); ?>" class="btn btn-info glyphicon glyphicon-pencil"> Alterar</a>
                        </td>
                        <td> <a  title="Ecluir Registro" href="excluirUnidade.php?idUnidade=<?php echo($result[0]); ?>" class="btn btn-danger simpleConfirm glyphicon glyphicon-trash"> Excluir</a> </td>                       
                     <?php }}else{ ?>
                     
                     <td colspan="3"><label for="Nao">Não há Unidade</label>  </td> 
