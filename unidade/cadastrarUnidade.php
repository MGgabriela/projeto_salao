      ...
      <script type="text/javascript">
			$().ready(function(){
				$('#formularioUnidade').validate({
					...
					messages:{
						descricaoCadastrar:{ required: 'Este Campo é obrigatorio' , remote: 'Esta Unidade já existe.'}
					}
            ...
            <div class="col-md-9">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
    					<h3 class="panel-title">Cadastrar Unidade</h3>
    				</div>
    				<div class="panel-body">
    					<form id="formularioUnidade" method="post" action="cadastrarUnidadeSalvar.php">
