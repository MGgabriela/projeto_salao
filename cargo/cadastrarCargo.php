      ...
      <script type="text/javascript">
			$().ready(function(){
				$('#formularioCargo').validate({
					...
					messages:{
						descricaoCadastrar:{ required: 'Este Campo é obrigatorio' , remote: 'Este Cargo já existe.'}
					}
            ...
            <div class="col-md-9">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
    					<h3 class="panel-title">Cadastrar Cargo</h3>
    				</div>
    				<div class="panel-body">
    					<form id="formularioCargo" method="post" action="cadastrarCargoSalvar.php">
