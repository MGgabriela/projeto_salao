...
extract($_GET);
$resul = mysql_fetch_array(mysql_query("select descricao from modelo where idModelo=$idModelo;"));
?>
<!DOCTYPE html>
<html><head>    
        <title>Senac</title>
      ...
      <script type="text/javascript">
			$().ready(function(){
				$('#formularioModelo').validate({
					...
					messages:{
						descricaoAlterar:{ required: 'Este Campo é obrigatorio' , remote: 'Esta Modelo já existe.'}
					}
            ...
            <div class="col-md-9">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
    					<h3 class="panel-title">Alterar Modelo</h3>
    				</div>
    				<div class="panel-body">
    					<form id="formularioModelo" method="post" action="alterarModeloSalvar.php">
                               ...
                               <div class="form-group">
                                  ...
                                  <div class="panel-body">
									...
									$sql = "select mm.idMaterial ,m.descricao, mm.qtd from material m, materialmodelo mm
									         where m.idMaterial=mm.idMaterial and mm.idModelo=$idModelo;";
                         		...
                         		<option value="">Selecione</option>        
								  <?php
									...
									while($result=mysql_fetch_array($busca)){
										if($resultMaterialModelo[0]==$result[0])
								  ...
								  ?>
                                           ...
                                           Quantidade <input type="text" class="form-control" name="qtd[]" value="<?php echo($resultMaterialModelo[2]) ?>"/>   
                              ...
                              <input type="hidden" name="descricaoAntigo" value="<?php echo($idModelo); ?>">
						</form>
    				</div>
				</div>
