...
<?php include("../menuSuperior.php"); ?>
    ...
    <div class="container-fluid">
           		...
           		<div class="panel panel-default">
                    ...
                    <form action="<?php $_SERVER["PHP_SELF"] ?>" method="get">
                        <div class="form-group">
                            ...
                            <input placeholder="Busca Por Modelo" name="nome" type="text">
      ...
      <div class="panel-heading"> <a href="cadastrarModelo.php"><button class="btn btn-info" type="button">Cadastrar Modelo</button></a></div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                     <?php 
						...
						$b = "select idModelo, descricao from modelo $buscaG order by descricao LIMIT $inicial, $numreg;";
						
						
						$busca = mysql_query($b);
						
						$b = "select idModelo, descricao from modelo $buscaG;";
                     ...
                     <tr>
                        ...
                        <td>
                        <a  title="Editar Registro" href="alterarModelo.php?idModelo=<?php echo($result[0]); ?>" class="btn btn-info glyphicon glyphicon-pencil"> Alterar</a>
                        </td>
                        <td> <a  title="Ecluir Registro" href="excluirModelo.php?idModelo=<?php echo($result[0]); ?>" class="btn btn-danger simpleConfirm glyphicon glyphicon-trash"> Excluir</a> </td>
                        
                         <td><a  title="Abrir Turma" href="../turma/cadastrarTurmaGerada.php?idModelo=<?php echo($result[0]); ?>" class="btn btn-success glyphicon glyphicon-pencil">Abrir Turma</a>	</td>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Dados da Modelo</h4>
                                  </div>
                                           ...
                                           <div class="panel panel-default">
                                              ...
                                              <div class="panel-body">
											   ...
											   <?php
											   	...
											   	$sql = "select mm.idMaterial ,m.descricao, mm.qtd from material m, materialmodelo mm
									         			where m.idMaterial=mm.idMaterial and mm.idModelo=$result[0];";
												$buscaMaterialModelo = mysql_query($sql);
												$cont = mysql_num_rows($buscaMaterialModelo);
									
												if($cont>0){
													while($resultMaterialModelo=mysql_fetch_array($buscaMaterialModelo)){
														echo($resultMaterialModelo[1]."<br>");
													}
                     ...
                     <td colspan="4"><label for="Nao">Não há Modelo</label>  </td> 
